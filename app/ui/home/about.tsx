      ...
      <div className="ml-0 mt-8 flex w-full flex-col gap-8 lg:ml-48 lg:mt-0 lg:w-7/12 lg:gap-16">
        <AnimateWrapper>
          <p className="text-lg leading-relaxed text-neutral-600 md:text-xl lg:text-2xl">
            ...
            personal trainer, offering you the blueprint to achieve your health and fitness goals
            from the comfort of your home.
          </p>
        </AnimateWrapper>
        <AnimateWrapper>
          <p className="text-lg leading-relaxed text-neutral-600 md:text-xl lg:text-2xl">
            For those seeking a more personalized touch, Zack offers the opportunity to work
            directly with him. With one-on-one sessions, you'll benefit from his extensive
            experience and achievements in fitness, receiving tailored guidance that's as unique as
