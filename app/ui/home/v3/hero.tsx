...
export default async function Hero() {
  return (
    <section className="pb- relative mx-2 mb-8 mt-[10vh] flex h-auto flex-col items-center rounded-xl border border-neutral-200 bg-gradient-to-b from-[#F9F9F7]  via-[#F5F7F9] to-[#E9EFF9] pt-16 md:mx-4 md:pt-28 lg:mx-6 lg:pb-0 lg:pt-8">
      <div className="mb-12  flex w-full flex-1 flex-col items-center gap-6 px-2 md:px-8 lg:gap-12  lg:px-12 lg:py-24">
        ...
        <p className="text-body mb-12  w-full text-center lg:mb-0 lg:w-[54ch] ">
