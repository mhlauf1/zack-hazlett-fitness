...
export default function Hero() {
  return (
    <section className="mx-4 my-4 flex h-auto flex-col justify-between rounded-md bg-neutral-200 px-6 pb-16 sm:mx-8 sm:my-8 md:mx-12 md:my-12 lg:mx-6 lg:my-24 lg:h-auto lg:flex-row">
