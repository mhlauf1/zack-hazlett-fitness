...
const FeaturedProgramCard: React.FC<ProgramCardProps> = ({ program, img, icon, small }) => {
  return (
    <Link
      className="relative flex flex-1 flex-col items-center rounded-lg border border-neutral-200 bg-neutral-50 px-8 py-6 duration-500 ease-in-out hover:border-blue-500 hover:bg-white"
